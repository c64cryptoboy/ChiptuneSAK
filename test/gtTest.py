...
def found_expected_note_content(rchirp_song):
    """
    # Generate expected output data for this test
    ...
    for i, expected_channel in enumerate(expected_channels):
        ...
        for expected_jiffy, expected_note in expected_channel:
            ...
            if rchirp_row is None:  # Make sure there's an actual entry at that expected jiffy
                return False
...
class TestGoatTrackerFunctions(unittest.TestCase):
    ...
    def test_sng_to_rchirp(self):
        ...
        self.assertTrue(found_expected_note_content(rchirp_song))
    ...
    def test_sng_to_rchirp_to_sng_to_rchirp(self):
        ...
        self.assertTrue(found_expected_note_content(rchirp_song_2))
