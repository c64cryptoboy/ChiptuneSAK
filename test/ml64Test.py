...
class TestExportML64(unittest.TestCase):
    def test_ML64_output_measures(self):
        ...
        known_good_ml64_file = project_to_absolute_path(
            "test/data/jingleBellsSDG_good.ml64"
        )
        known_good_ml64_hash = ctsTestingTools.md5_hash_no_spaces_file(
            known_good_ml64_file
        )
        ...
        known_good_ml64_file = project_to_absolute_path(
            "test/data/bach_invention_4_good.ml64"
        )
        known_good_ml64_hash = ctsTestingTools.md5_hash_no_spaces_file(
            known_good_ml64_file
        )
    ...
    def test_ML64_standard(self):
        ...
        midi_file = project_to_absolute_path("test/data/bach_invention_4.mid")
        known_good_ml64_file = project_to_absolute_path(
            "test/data/bach_invention_4_good_std.ml64"
        )
        known_good_ml64_hash = ctsTestingTools.md5_hash_no_spaces_file(
            known_good_ml64_file
        )
    ...
    def test_ML64_compact_modulation(self):
        ...
        known_good_ml64_file = project_to_absolute_path(
            "test/data/tripletTest_good.ml64"
        )
        known_good_ml64_hash = ctsTestingTools.md5_hash_no_spaces_file(
            known_good_ml64_file
        )
