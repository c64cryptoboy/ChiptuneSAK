...
KNOWN_GOOD_LY_FILE_CLIP = project_to_absolute_path(
    "test/data/bach_invention_4_clip_good.ly"
)


class TestExportLilypond(unittest.TestCase):
    def test_lilypond_(self):
        known_good_ly_hash = ctsTestingTools.md5_hash_no_spaces_file(
            KNOWN_GOOD_LY_FILE_CLIP
        )
