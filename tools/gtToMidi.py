...
def main():
    parser = argparse.ArgumentParser(
        description="Convert a GoatTracker2 sng file to a midi file."
    )
    ...
    rchirp_song = ctsGoatTracker.GoatTracker().to_rchirp(
        args.sng_in_file, subtune=args.subtune_number
    )
